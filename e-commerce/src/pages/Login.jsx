          ...
          <div className="flex flex-col items-center gap-4 w-full mx-5">
            ...
            <div className="relative w-full">
              <input
                ...
                className="border-white border-2 rounded-lg text-white p-4 w-full outline-none focus:shadow-lg focus:shadow-white transition-shadow pr-12"
                name="password"
            ...
            <p className="text-white font-extrabold text-wrap">
